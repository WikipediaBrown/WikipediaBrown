...
//   (3) rotating 3D ASCII Mac mini — pre-rendered frame cycler (generator:
//       docs/_tools/macmini_3d.py — chunky M4-cube proportions, ambient +
//       Lambertian shading, Apple-logo recess on top, 36 frames around Y).
...
const MAC_MINI_FRAMES = [
  ...
  if (mac) cycleFrames(mac, MAC_MINI_FRAMES, { fps: 8 });
})();

// Cycle a pre-rendered array of ASCII frames. Atomic textContent per frame.
