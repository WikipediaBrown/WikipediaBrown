...
Tiny Swift package that makes [SF Symbols](https://developer.apple.com/sf-symbols/) painless. Extensions on `String`, `UIImage`, and `NSImage`; full [symbol catalog](https://developer.apple.com/design/human-interface-guidelines/sf-symbols) generated by a Python script.
